...
namespace gtypes
{
	...
	{
		this->data[0] = m0; this->data[4] = m4; this->data[8]  = m8;  this->data[12] = m12;
		this->data[1] = m1; this->data[5] = m5; this->data[9]  = m9;  this->data[13] = m13;
		this->data[2] = m2; this->data[6] = m6; this->data[10] = m10; this->data[14] = m14;
		this->data[3] = m3; this->data[7] = m7; this->data[11] = m11; this->data[15] = m15;
	}

	Matrix4::Matrix4(const Matrix3& m)
	{
		this->data[0] = m[0]; this->data[4] = m[3]; this->data[8]  = m[6]; this->data[12] = 0.0;
		this->data[1] = m[1]; this->data[5] = m[4]; this->data[9]  = m[7]; this->data[13] = 0.0;
		this->data[2] = m[2]; this->data[6] = m[5]; this->data[10] = m[8]; this->data[14] = 0.0;
		this->data[3] = 0.0;  this->data[7] = 0.0;  this->data[11] = 0.0;  this->data[15] = 1.0;
	}

	Matrix4::Matrix4(const Matrix4& m)
	{
		this->data[0] = m[0]; this->data[4] = m[4]; this->data[8]  = m[8];  this->data[12] = m[12];
		this->data[1] = m[1]; this->data[5] = m[5]; this->data[9]  = m[9];  this->data[13] = m[13];
		this->data[2] = m[2]; this->data[6] = m[6]; this->data[10] = m[10]; this->data[14] = m[14];
		this->data[3] = m[3]; this->data[7] = m[7]; this->data[11] = m[11]; this->data[15] = m[15];
	}
	...
	{
		setRotation(axis, (float)DEG_TO_RAD(angle));
	}

	Matrix4::Matrix4(float x, float y, float z, float angle)
	{
		setRotation(Vector3(x,y,z), (float)DEG_TO_RAD(angle));
	}
	...
	{
		return Matrix4(this->data[0], this->data[1],  this->data[2], 0,
					   this->data[4], this->data[5],  this->data[6], 0,
					   this->data[8], this->data[9], this->data[10], 0,
								  0, 			0, 			   0, 1);
	}
	...
	{
		set(this->data[0],  this->data[4],  this->data[8],  this->data[3],
	...
	{
		Matrix4 data(*this);
		data.inverseRotation();
		return data;
	}
	
	void Matrix4::setZero()
	{
		this->data[0] = 0.0; this->data[4] = 0.0; this->data[8] = 0.0; this->data[12] = 0.0;
		this->data[1] = 0.0; this->data[5] = 0.0; this->data[9] = 0.0; this->data[13] = 0.0;
		this->data[2] = 0.0; this->data[6] = 0.0; this->data[10] = 0.0; this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 0.0;
	}
	
	void Matrix4::setIdentity()
	{
		this->data[0] = 1.0; this->data[4] = 0.0; this->data[8]  = 0.0; this->data[12] = 0.0;
		this->data[1] = 0.0; this->data[5] = 1.0; this->data[9]  = 0.0; this->data[13] = 0.0;
		this->data[2] = 0.0; this->data[6] = 0.0; this->data[10] = 1.0; this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	...
	{
		return Matrix4(this->data[0], this->data[4], this->data[8],  this->data[12],
	...
	{
		this->data[0] = 1.0; this->data[4] = 0.0; this->data[8]  = 0.0; this->data[12] = v.x;
		this->data[1] = 0.0; this->data[5] = 1.0; this->data[9]  = 0.0; this->data[13] = v.y;
		this->data[2] = 0.0; this->data[6] = 0.0; this->data[10] = 1.0; this->data[14] = v.z;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	...
	{
		Matrix4 data; data.setTranslation(v);
		this->operator*=(data);
	}

	void Matrix4::translate(float x, float y, float z)
	{
		Matrix4 data; data.setTranslation(x,y,z);
		this->operator*=(data);
	}
	...
	{
		this->data[0] =   x; this->data[4] = 0.0; this->data[8]  = 0.0; this->data[12] = 0.0;
		this->data[1] = 0.0; this->data[5] =   y; this->data[9]  = 0.0; this->data[13] = 0.0;
		this->data[2] = 0.0; this->data[6] = 0.0; this->data[10] =   z; this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	
	void Matrix4::scale(float factor)
	{
		Matrix4 data; data.setScale(factor);
		this->operator*=(data);
	}
	
	void Matrix4::scale(float x, float y, float z)
	{
		Matrix4 data; data.setScale(x,y,z);
		this->operator*=(data);
	}
	
	void Matrix4::scale(const gtypes::Vector3 &v)
	{
		Matrix4 data; data.setScale(v);
		this->operator*=(data);
	}
	...
	void Matrix4::perspective(float fov, float aspect, float near, float far)
	{
		...
		float x = y * aspect;
		this->data[0] = 1.0f / x; this->data[4] = 0.0;	  this->data[8] = 0.0;							this->data[12] = 0.0;
		this->data[1] = 0.0;	  this->data[5] = 1.0f / y; this->data[9] = 0.0;							this->data[13] = 0.0;
		this->data[2] = 0.0;	  this->data[6] = 0.0;	  this->data[10] = -(far + near) / (far - near);  this->data[14] = -(2.0f * far * near) / (far - near);
		this->data[3] = 0.0;	  this->data[7] = 0.0;	  this->data[11] = -1.0;						  this->data[15] = 0.0;
	}
	...
	void Matrix4::ortho(float w,float h,float x_offset,float y_offset)
	{
		...
		this->data[5]=-2/h;
		this->data[10]=-2;
		this->data[12]=-1-x_offset*2/w;
		this->data[13]=1+y_offset*2/h;
	}
	...
	void Matrix4::setReflection(const Vector4& plane)
	{
		...
		float y2 = y * 2.0f;
		float z2 = z * 2.0f;
		this->data[0] = 1.0f - x * x2; this->data[4] = -y * x2;	   this->data[8] = -z * x2;		this->data[12] = -plane.w * x2;
		this->data[1] = -x * y2;	   this->data[5] = 1.0f - y * y2; this->data[9] = -z * y2;		this->data[13] = -plane.w * y2;
		this->data[2] = -x * z2;	   this->data[6] = -y * z2;	   this->data[10] = 1.0f - z * z2; this->data[14] = -plane.w * z2;
		this->data[3] = 0.0;		   this->data[7] = 0.0;		   this->data[11] = 0.0;		   this->data[15] = 1.0;
	}
	...
	{
		Matrix4 data; data.setReflection(plane);
		this->operator*=(data);
	}

	void Matrix4::reflect(float x, float y, float z, float w)
	{
		Matrix4 data; data.setReflection(x,y,z,w);
		this->operator*=(data);
	}
	...
	void Matrix4::setRotationX(float angle)
	{
		...
		float s = (float)sin(rad);
		this->data[0] = 1.0; this->data[4] = 0.0; this->data[8]  = 0.0; this->data[12] = 0.0;
		this->data[1] = 0.0; this->data[5] =  c;  this->data[9]  = -s;  this->data[13] = 0.0;
		this->data[2] = 0.0; this->data[6] =  s;  this->data[10] =  c;  this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	...
	void Matrix4::setRotationY(float angle)
	{
		...
		float c = (float)cos(rad);
		float s = (float)sin(rad);
		this->data[0] =  c;  this->data[4] = 0.0; this->data[8]  =  s;  this->data[12] = 0.0;
		this->data[1] = 0.0; this->data[5] = 1.0; this->data[9]  = 0.0; this->data[13] = 0.0;
		this->data[2] = -s;  this->data[6] = 0.0; this->data[10] =  c;  this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	...
	void Matrix4::setRotationZ(float angle)
	{
		...
		float c = (float)cos(rad);
		float s = (float)sin(rad);
		this->data[0] =  c;  this->data[4] = -s;  this->data[8]  = 0.0; this->data[12] = 0.0;
		this->data[1] =  s;  this->data[5] =  c;  this->data[9]  = 0.0; this->data[13] = 0.0;
		this->data[2] = 0.0; this->data[6] = 0.0; this->data[10] = 1.0; this->data[14] = 0.0;
		this->data[3] = 0.0; this->data[7] = 0.0; this->data[11] = 0.0; this->data[15] = 1.0;
	}
	...
	{
		Matrix4 data; data.setRotation(axis,angle);
		this->operator*=(data);
	}

	void Matrix4::rotate(float x, float y, float z, float angle)
	{
		Matrix4 data; data.setRotation(x,y,z,angle);
		this->operator*=(data);
	}

	void Matrix4::rotateX(float angle)
	{
		Matrix4 data; data.setRotationX(angle);
		this->operator*=(data);
	}
	void Matrix4::rotateY(float angle)
	{
		Matrix4 data; data.setRotationY(angle);
		this->operator*=(data);		
	}
	void Matrix4::rotateZ(float angle)
	{
		Matrix4 data; data.setRotationZ(angle);
		this->operator*=(data);
	}
